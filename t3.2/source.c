 ...
 *  4. If the user entry is not in the expected format, the function should
 * print ERR
 *  5. If the user enters any other operator than the above stated ones, the
 * function should print ERR
 ...
 *     a single decimal.
 * An example call of the function is shown below. The input from the user is
 * marked with an @ sign:
 *  @  8 - 2
 *     6.0
 *  @  5 * 5
 ...
 *     ERR
 * Hint
 * - Check the scanf function documentation
